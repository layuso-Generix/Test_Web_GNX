...
const I18N = {
 es: {
  ...
  'spec.format':'Formato','spec.category':'Categoría','spec.folder':'Carpeta','spec.schema':'Schema','spec.version':'Versión','spec.releaseDate':'Fecha de lanzamiento','spec.example':'Ejemplo','spec.exampleN':'Ejemplo {n}',
 ...
 en: {
  ...
  'spec.format':'Format','spec.category':'Category','spec.folder':'Folder','spec.schema':'Schema','spec.version':'Version','spec.releaseDate':'Release Date','spec.example':'Example','spec.exampleN':'Example {n}',
